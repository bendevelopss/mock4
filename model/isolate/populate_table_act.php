...
"; 
  ...
  {
    $output[] = array ($fetch['description'],$fetch['pay_item_id'], $fetch['station'],$fetch['qty'],$fetch['done'],$fetch['part'],$fetch['partadd'],$fetch['part-trans_id']);
  }
$conn = null;
